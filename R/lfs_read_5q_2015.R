...
lfs_read_5q_2015 <- function(
  ...
  cat(crayon::yellow("Reading LFS 2015:\n"))

  ###### Read in each quarter
  cat(crayon::green("\tJan-Mar 2015 to Jan-Mar 2016"))
  data.q1 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_jm15-jm16_eul_lgwt17.tab"), showProgress = FALSE,
  ...
  cat(crayon::green("\tApr-Jun 2015 to Apr-Jun 2016"))
  data.q2 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_aj15-aj16_eul_lgwt17.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  cat(crayon::green("\tJul-Sep 2015 to Jul-Sep 2016"))
  data.q3 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_js15-js16_eul_lgwt17.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  cat(crayon::green("\tOct-Dec 2015 to Oct-Dec 2016"))
  data.q4 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_od15-od16_eul_lgwt17.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
