...
lfs_read_5q_2019 <- function(
  ...
  cat(crayon::yellow("Reading LFS 2019:\n"))

  ###### Read in each quarter
  cat(crayon::green("\tJan-Mar 2019 to Jan-Mar 2020"))
  data.q1 <- data.table::fread(
    paste0(path,"/lgwt22_5q_jm19_jm20_eul.tab"), showProgress = FALSE,
  ...
  cat(crayon::green("\tApr-Jun 2019 to Apr-Jun 2020"))
  data.q2 <- data.table::fread(
    paste0(path,"/lgwt22_5q_aj19_aj20_eul.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  cat(crayon::green("\tJul-Sep 2019 to Jul-Sep 2020"))
  data.q3 <- data.table::fread(
    paste0(path,"/lgwt22_5q_js19_js20_eul.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  cat(crayon::green("\tOct-Dec 2019 to Oct-Dec 2020"))
  data.q4 <- data.table::fread(
    paste0(path,"/lgwt22_5q_od19_od20_eul.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
