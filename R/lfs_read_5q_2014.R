...
lfs_read_5q_2014 <- function(
  ...
  cat(crayon::yellow("Reading LFS 2014:\n"))

  ###### Read in each quarter
  cat(crayon::green("\tJan-Mar 2014 to Jan-Mar 2015"))
  data.q1 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_jm14-jm15_eul_lgwt17.tab"), showProgress = FALSE,
  ...
  cat(crayon::green("\tApr-Jun 2014 to Apr-Jun 2015"))
  data.q2 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_aj14-aj15_eul_lgwt17.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  cat(crayon::green("\tJul-Sep 2014 to Jul-Sep 2015"))
  data.q3 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_js14-js15_eul_lgwt17.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  cat(crayon::green("\tOct-Dec 2014 to Oct-Dec 2015"))
  data.q4 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_od14-od15_eul_lgwt17.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  for (l in c(2)) {
    ...
    setnames(data,
             c("lgwt17","hiqul11d1","hiqul11d2","hiqul11d3","hiqul15d4","hiqul15d5"),
             c("lgwt22","hiqul22d1","hiqul22d2","hiqul22d3","hiqul22d4","hiqul22d5"))
  ...
  for (l in c(3)) {
    ...
    setnames(data,
             c("lgwt17","hiqul11d1","hiqul11d2","hiqul15d3","hiqul15d4","hiqul15d5"),
             c("lgwt22","hiqul22d1","hiqul22d2","hiqul22d3","hiqul22d4","hiqul22d5"))
  ...
  for (l in c(4)) {
    ...
    setnames(data,
             c("lgwt17","hiqul11d1","hiqul15d2","hiqul15d3","hiqul15d4","hiqul15d5"),
             c("lgwt22","hiqul22d1","hiqul22d2","hiqul22d3","hiqul22d4","hiqul22d5"))
