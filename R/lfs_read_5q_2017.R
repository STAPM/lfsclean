...
lfs_read_5q_2017 <- function(
  ...
  cat(crayon::yellow("Reading LFS 2017:\n"))

  ###### Read in each quarter
  cat(crayon::green("\tJan-Mar 2017 to Jan-Mar 2018"))
  data.q1 <- data.table::fread(
    paste0(path,"/fiveq_longitudinal_jm17-jm18_eul_lgwt17.tab"), showProgress = FALSE,
  ...
  cat(crayon::green("\tApr-Jun 2017 to Apr-Jun 2018"))
  data.q2 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_aj17-aj18_eul_lgwt17.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  cat(crayon::green("\tJul-Sep 2017 to Jul-Sep 2018"))
  data.q3 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_js17-js18_eul_lgwt17.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
  ...
  cat(crayon::green("\tOct-Dec 2017 to Oct-Dec 2018"))
  data.q4 <- data.table::fread(
    paste0(path,"/five_q_longitudinal_od17-od18_eul_lgwt17.tab"), showProgress = FALSE,
    na.strings = c("NA", "", "-1", "-2", "-6", "-7", "-8", "-9", "-90", "-90.0", "N/A")
  )
